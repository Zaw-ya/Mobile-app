class Routes {
  ...
  static const String clientMessagesStatisticsScreen =
      '/clientMessagesStatisticsScreen';
  static const String clientConfirmationServicesScreen =
      '/clientConfirmationServicesScreen';
